...
(let ((font-family-serif "Iosevka Sparkle")
      (font-family-sans "IBM Plex Sans")
      (font-family-mono "IBM Plex Mono")
      (font-family-mono-prose "Dejavu Sans Mono"))
  
(set-face-attribute 'org-document-title nil  :height 145 :weight 'semi-bold))
...
(with-eval-after-load 'markdown-mode
  (set-face-attribute 'markdown-header-face nil :family "Iosevka Sparkle")
